...
class MPC_controller(BaseControl):
    ...
    def computeControl(self,
        ...
        rpm = self.MPCTrajectoryControl(control_timestep,
                        cur_pos,
                        cur_quat,
                        cur_vel,
                        cur_ang_vel,
    ...
    def MPCTrajectoryControl(self,
        ...
        for k in range(self.horizon):
            ...
            cost += cp.norm(x[2,k]-10, 2)**2 + cp.norm(x[0,k]-200,2)**2
